    ...
    <section className="relative min-h-screen bg-[#fdfdfd] text-black py-24 px-6 sm:px-12 lg:px-24 overflow-hidden border-t border-black/5">
      ...
      <div className="max-w-4xl mx-auto relative z-10 pt-10">
        ...
        <div className="space-y-12 font-light text-lg leading-relaxed">
            ...
            >
                <h2 className="text-2xl font-outfit font-medium text-[#111] mb-4">Introduction</h2>
            ...
            <motion.section 
                ...
                className="border-l border-black/10 pl-8"
            >
                <h2 className="text-2xl font-outfit font-medium text-[#111] mb-4">Information We Collect</h2>
                <p className="text-gray-600 mb-4">
                    We collect information only when it is necessary to provide our
                    services or respond to your requests.
                </p>
                <ul className="list-none space-y-3 text-gray-600 font-mono text-sm tracking-wide">
            ...
            <motion.section 
                ...
                className="border-l border-black/10 pl-8"
            >
                <h2 className="text-2xl font-outfit font-medium text-[#111] mb-4">How We Use Your Information</h2>
                <p className="text-gray-600 mb-4">
            ...
            <motion.section 
                ...
                className="border-l border-black/10 pl-8"
            >
                <h2 className="text-2xl font-outfit font-medium text-[#111] mb-4">
                    Cookies & Tracking
                </h2>
                <p className="text-gray-600">
            ...
            <motion.section 
                ...
                className="border-l border-black/10 pl-8"
            >
                <h2 className="text-2xl font-outfit font-medium text-[#111] mb-4">Data Security</h2>
                <p className="text-gray-600">
