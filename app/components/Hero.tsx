      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto flex flex-col items-center justify-center text-center">
        ...
        >
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.1] tracking-tight mb-8">
            ...
            <span className="block text-[#111]">We Design We Develop.</span>
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            ...
            <Link
              href="/projects"
              className="px-8 py-4 rounded-md border-2 border-gray-200 text-gray-800 font-semibold text-sm uppercase tracking-wider hover:border-black transition-colors flex items-center justify-center gap-2"
            >
              VIEW PROJECTS
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7 17l9.2-9.2M17 16.8V7H7.2"/></svg>
            </Link>
