      ...
      >
        ...
        <section className="mb-4">
          ...
          <p className="text-gray-300">
            ...
            <br />
            <a href="mailto:fozecode@gmail.com" className="text-cyan-400 hover:underline">Spabrix@gmail.com</a>
            <br />
            Phone: <a href="tel:+919946972210" className="text-cyan-400 hover:underline">+91 9946972210</a>
          </p>
        </section>
