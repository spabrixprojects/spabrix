    ...
    <section className="relative min-h-screen bg-[#050505] text-white py-40 px-6 sm:px-12 lg:px-24 overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-4xl mx-auto relative z-10 pt-10">
        ...
        <div className="space-y-24 font-light text-xl leading-relaxed">
            ...
            >
                <h2 className="text-3xl font-outfit font-medium text-white mb-6">Acceptance of Terms</h2>
            ...
            <motion.section 
                ...
                className="border-l border-white/20 pl-8"
            >
                <h2 className="text-3xl font-outfit font-medium text-white mb-6">Use of Services</h2>
                <p className="text-slate-400">
            ...
            <motion.section 
                ...
                className="border-l border-white/20 pl-8"
            >
                <h2 className="text-3xl font-outfit font-medium text-white mb-6">Intellectual Property</h2>
                <p className="text-slate-400">
            ...
            <motion.section 
                ...
                className="border-l border-white/20 pl-8"
            >
                <h2 className="text-3xl font-outfit font-medium text-white mb-6">Limitation of Liability</h2>
                <p className="text-slate-400">
            ...
            <motion.section 
                ...
                className="border-l border-white/20 pl-8"
            >
                <h2 className="text-3xl font-outfit font-medium text-white mb-6">Changes to Terms</h2>
                <p className="text-slate-400">
